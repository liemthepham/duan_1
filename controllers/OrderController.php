...
class OrderController
{
    ...
    public function detail() {
        ...
        $stmt = $this->pdo->prepare("SELECT d.*, u.TenDangNhap, u.HoTen, d.SoDienThoai, d.DiaChi FROM donhang d LEFT JOIN nguoidung u ON d.MaNguoiDung = u.MaNguoiDung WHERE d.MaDonHang = ?");
    ...
    public function listOrders() {
        ...
        $stmt = $this->pdo->prepare("SELECT d.*, u.TenDangNhap, u.HoTen FROM donhang d LEFT JOIN nguoidung u ON d.MaNguoiDung = u.MaNguoiDung WHERE d.MaNguoiDung = ? ORDER BY NgayDatHang DESC");
        $stmt->execute([$userId]);
